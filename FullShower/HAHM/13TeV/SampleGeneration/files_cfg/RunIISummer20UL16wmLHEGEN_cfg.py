...
# with command line options: Configuration/GenProduction/python/JME-RunIISummer20UL16wmLHEGEN-01293-fragment.py --python_filename RunIISummer20UL16wmLHEGEN_cfg.py --eventcontent RAWSIM,LHE --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN,LHE --fileout file:__OUTPUT__.root --conditions 106X_mcRun2_asymptotic_v13 --beamspot Realistic25ns13TeV2016Collision --step LHE,GEN --geometry DB:Extended --era Run2_2016 --no_exec --mc -n 1
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/JME-RunIISummer20UL16wmLHEGEN-01293-fragment.py nevts:1'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:__OUTPUT___inLHE.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/cvmfs/cms.cern.ch/phys_generator/gridpacks/2017/13TeV/madgraph/V5_2.6.5/QCD_HT_LO_MLM/newPR/QCD_HT300to500_slc7_amd64_gcc700_CMSSW_10_6_19_tarball.tar.xz'),
